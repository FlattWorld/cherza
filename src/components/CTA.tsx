...
const CTA = ({ language }: { language: 'EN' | 'ES' }): JSX.Element => (
  <a
    href="#contact"
    className="text-2xl relative flex items-center justify-center group z-10 px-6 py-10 rounded-full font-cherza-header"
  >
    ...
    group-hover:w-36 group-hover:h-36 absolute transition-all duration-500"
    ></div>
  </a>
)
